function [lkl,filtp,filts,smoothp,smooths,clkl] = ffbsX(Xt,Zt,rho,G,P,ip,scale_clkl)
%% ffbsX Forward-Filtering Backward-Sampling for ZIL-T-MS model with matrix observations and common covariates
%

...
%% DGP_ZIL_MS_tensor_K_input_G Simulate dataset from the ZIL-T-MS model with K > 1 and common covariates, starting from a given coefficient tensor provided as input.
%

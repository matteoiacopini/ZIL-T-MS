function [OUT] = Bayes_ZIL_T_MS_1l_FUNC(Xt,Zt, nameArgs)
%% Bayes_ZIL_T_MS_1l_FUNC Estimate the Bayesian Zero-Inflated Logit Tensor model with Markov Switching coefficients (ZIL-T-MS) with common covariates and K=1 layers
%
%   [OUT] = Bayes_ZIL_T_MS_1l_FUNC(XT,ZT,NAMEARGS)

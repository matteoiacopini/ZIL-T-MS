%% Estimate the ZIL-T-MS model on an a financial dataset
...
disp('%%%%%%%%% Running script file:  main_financial.m   %%%%%%%%%');

addpath(genpath('./functions'));
addpath('./Input');

% LOAD data
load('Data_financial.mat');


% MCMC settings
L       = 2;       % number of states
R       = 10;      % CP tensor rank (actual is Rbar = R/2, due to constraint on coefficient tensor)
